...
/* harmony import */ var _translation_loader_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./translation-loader.service */ "../frontend/app-store-catalog/src/app/translation-loader.service.ts");
/* harmony import */ var _global_options_population__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./global-options-population */ "../frontend/app-store-catalog/src/app/global-options-population.ts");
        ...
        { provide: _angular_common__WEBPACK_IMPORTED_MODULE_11__["LocationStrategy"], useClass: _angular_common__WEBPACK_IMPORTED_MODULE_11__["HashLocationStrategy"] },
            ...
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"].forRoot({
                loader: {
                    ...
                    useClass: _translation_loader_service__WEBPACK_IMPORTED_MODULE_12__["TranslationLoaderService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "globalOptionsPopulation", function() { return globalOptionsPopulation; });
...
function globalOptionsPopulation() {
    if (window['catalogSpaOptions']) {
        ...
        if (catalogSpaOptions.tenantId) {
            _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].tenantId = catalogSpaOptions.tenantId;
        }
        if (catalogSpaOptions.tenantDomain) {
            _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].tenantDomain = catalogSpaOptions.tenantDomain;
        }
        if (catalogSpaOptions.language) {
            _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].language = catalogSpaOptions.language;
        }
        if (catalogSpaOptions.apiUrl) {
            _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl = catalogSpaOptions.apiUrl;
        }
    }
}
...
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./i18n */ "../frontend/app-store-catalog/src/app/i18n/index.ts");
...
class TranslationLoaderService {
    getTranslation(lang) {
        var _a;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])((_a = _i18n__WEBPACK_IMPORTED_MODULE_2__[lang]) !== null && _a !== void 0 ? _a : {});
    }
}
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PartnerType", function() { return _model_models__WEBPACK_IMPORTED_MODULE_1__["PartnerType"]; });
...
/* harmony import */ var _partnerType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./partnerType */ "../frontend/app-store-catalog/swagger/model/partnerType.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PartnerType", function() { return _partnerType__WEBPACK_IMPORTED_MODULE_1__["PartnerType"]; });
