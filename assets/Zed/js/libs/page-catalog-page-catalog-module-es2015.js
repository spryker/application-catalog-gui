...
class PageCatalogComponent {
    ...
    ngOnInit() {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => this.prepareCardData(res)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destoyed$)).subscribe(apps => {
