...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../types */ "../frontend/app-store-catalog/src/page-catalog/types.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "../node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _assets_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../assets/icons */ "../frontend/app-store-catalog/src/assets/icons/index.ts");
...
/* harmony import */ var _spryker_icon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @spryker/icon */ "../node_modules/@spryker/icon/__ivy_ngcc__/fesm2015/spryker-icon.js");
/* harmony import */ var _common_connected_badge_connected_badge_connected_badge_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../common/connected-badge/connected-badge/connected-badge.component */ "../frontend/app-store-catalog/src/common/connected-badge/connected-badge/connected-badge.component.ts");
/* harmony import */ var _spryker_chips__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @spryker/chips */ "../node_modules/@spryker/chips/__ivy_ngcc__/fesm2015/spryker-chips.js");
...
function ApplicationCardComponent_spy_card_0_ng_template_13_Template(rf, ctx) { if (rf & 1) {
...
function ApplicationCardComponent_spy_card_0_app_status_badge_15_Template(rf, ctx) { if (rf & 1) {
...
class ApplicationCardComponent {
    ...
    getPartnerTypeIcon() {
        var _a;
        return ((_a = this.app) === null || _a === void 0 ? void 0 : _a.partnerType) === _types__WEBPACK_IMPORTED_MODULE_1__["PartnerType"].Silver
            ? _assets_icons__WEBPACK_IMPORTED_MODULE_3__["IconSilverPartnerCircleModule"].icon
            : _assets_icons__WEBPACK_IMPORTED_MODULE_3__["IconGoldPartnerCircleModule"].icon;
    }
...
ApplicationCardComponent.ɵfac = function ApplicationCardComponent_Factory(t) { return new (t || ApplicationCardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
ApplicationCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ApplicationCardComponent, selectors: [["app-application-card"]], hostAttrs: [1, "application-card"], inputs: { app: "app" }, decls: 3, vars: 1, consts: [["hoverable", "", 3, "actions", "click", 4, "ngIf"], ["categories", ""], ["hoverable", "", 3, "actions", "click"], [1, "spy-row"], [1, "spy-col"], [1, "application-card__logo", 3, "src", "alt"], ["class", "spy-col-2 application-card__partner-type", 4, "ngIf"], [1, "application-card__title"], [1, "application-card__description"], [1, "application-card__rate"], ["nzDisabled", "", 1, "application-card__rate-value", 3, "ngModel", "nzCharacter"], [1, "application-card__rate-count"], ["characterRate", ""], ["class", "application-card__connected-badge", 3, "status", 4, "ngIf"], [1, "spy-col-2", "application-card__partner-type"], [1, "application-card__partner-type-icon", 3, "name"], [3, "name"], [1, "application-card__connected-badge", 3, "status"], ["color", "gray", "maxWidth", "none", 4, "ngFor", "ngForOf"], ["color", "gray", "maxWidth", "none"]], template: function ApplicationCardComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _spryker_card__WEBPACK_IMPORTED_MODULE_6__["CardComponent"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_7__["NzRateComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["NgModel"], _spryker_icon__WEBPACK_IMPORTED_MODULE_9__["IconComponent"], _common_connected_badge_connected_badge_connected_badge_component__WEBPACK_IMPORTED_MODULE_10__["ConnectedBadgeComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _spryker_chips__WEBPACK_IMPORTED_MODULE_11__["ChipsComponent"]], styles: ["@import url('https://fonts.googleapis.com/css?family=Montserrat:400,500,600&display=swap');\n/* prettier-ignore */\n/**\n * Returns a map with the list of properties that should generate grid selectors with breakpoints.\n */\n/* stylelint-disable at-rule-empty-line-before,at-rule-name-space-after,at-rule-no-unknown */\n/* stylelint-disable no-duplicate-selectors */\n/* stylelint-disable */\n/* stylelint-disable declaration-bang-space-before,no-duplicate-selectors,string-no-newline */\n.ant-rate {\n  box-sizing: border-box;\n  color: rgba(0, 0, 0, 0.65);\n  font-size: 14px;\n  font-variant: tabular-nums;\n  line-height: 1.5715;\n  font-feature-settings: 'tnum';\n  display: inline-block;\n  margin: 0;\n  padding: 0;\n  color: #fadb14;\n  font-size: 20px;\n  line-height: unset;\n  list-style: none;\n  outline: none;\n}\n.ant-rate-disabled .ant-rate-star {\n  cursor: default;\n}\n.ant-rate-disabled .ant-rate-star:hover {\n  transform: scale(1);\n}\n.ant-rate-star {\n  position: relative;\n  display: inline-block;\n  margin: 0;\n  padding: 0;\n  color: inherit;\n  cursor: pointer;\n  transition: all 0.3s;\n}\n.ant-rate-star:not(:last-child) {\n  margin-right: 8px;\n}\n.ant-rate-star > div:focus {\n  outline: 0;\n}\n.ant-rate-star > div:hover,\n.ant-rate-star > div:focus {\n  transform: scale(1.1);\n}\n.ant-rate-star-first,\n.ant-rate-star-second {\n  color: #f0f0f0;\n  transition: all 0.3s;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n          user-select: none;\n}\n.ant-rate-star-first .anticon,\n.ant-rate-star-second .anticon {\n  vertical-align: middle;\n}\n.ant-rate-star-first {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 50%;\n  height: 100%;\n  overflow: hidden;\n  opacity: 0;\n}\n.ant-rate-star-half .ant-rate-star-first,\n.ant-rate-star-half .ant-rate-star-second {\n  opacity: 1;\n}\n.ant-rate-star-half .ant-rate-star-first,\n.ant-rate-star-full .ant-rate-star-second {\n  color: inherit;\n}\n.ant-rate-text {\n  display: inline-block;\n  margin-left: 8px;\n  font-size: 14px;\n}\n.ant-rate-rtl {\n  direction: rtl;\n}\n.ant-rate-rtl .ant-rate-star:not(:last-child) {\n  margin-right: 0;\n  margin-left: 8px;\n}\n.ant-rate-rtl .ant-rate-star-first {\n  right: 0;\n  left: auto;\n}\n.ant-rate-rtl .ant-rate-text {\n  margin-right: 8px;\n  margin-left: 0;\n}\n.application-card {\n  display: block;\n  width: 370px;\n  margin-bottom: 20px;\n}\n.application-card .ant-card-body {\n  min-height: 290px;\n  padding: 20px 30px;\n}\n.application-card .ant-card-actions {\n  padding: 0 24px;\n}\n.application-card .ant-card-actions li {\n  text-align: left;\n}\n.application-card__logo {\n  display: block;\n  height: 26px;\n  margin: 5px 0 30px 0;\n}\n.application-card__partner-type {\n  font-size: 40px;\n  text-align: right;\n}\n.application-card__title {\n  font-size: 16px;\n  font-weight: 600;\n  color: #121212;\n  margin: 10px 0;\n}\n.application-card__description {\n  font-weight: 500;\n  line-height: 2.07438;\n}\n.application-card__connected-badge {\n  margin: 16px 0 0;\n}\n.application-card__rate {\n  margin-top: 8px 0 0;\n}\n.application-card__rate-value .ant-rate {\n  color: #fdaf1c;\n}\n.application-card__rate-value .ant-rate-star:not(:last-child) {\n  margin: 0;\n}\n.application-card__rate-count {\n  display: inline-block;\n  vertical-align: top;\n  line-height: 21px;\n  margin-left: 6px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"], encapsulation: 2, changeDetection: 0 });
(function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ApplicationCardComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, { app: [{
...
FiltersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FiltersComponent, selectors: [["app-filters"]], hostAttrs: [1, "app-filters"], inputs: { filterItems: "filterItems" }, decls: 1, vars: 1, consts: [["class", "app-filters__item", "maxWidth", "none", 4, "ngFor", "ngForOf"], ["maxWidth", "none", 1, "app-filters__item"], [1, "app-filters__item-icon", 3, "name"]], template: function FiltersComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _spryker_chips__WEBPACK_IMPORTED_MODULE_2__["ChipsComponent"], _spryker_icon__WEBPACK_IMPORTED_MODULE_3__["IconComponent"]], styles: ["@import url('https://fonts.googleapis.com/css?family=Montserrat:400,500,600&display=swap');\n/* prettier-ignore */\n/**\n * Returns a map with the list of properties that should generate grid selectors with breakpoints.\n */\n.app-filters__item.spy-chips {\n  padding: 13px 16px 11px 16px;\n  background-color: #fff;\n  color: #121212;\n  line-height: 22px;\n  margin: 0 19px 0 0;\n}\n.app-filters__item-icon {\n  vertical-align: middle;\n  margin: 0 10px 0 0;\n  font-size: 22px;\n  line-height: 24px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"], encapsulation: 2, changeDetection: 0 });
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../types */ "../frontend/app-store-catalog/src/page-catalog/types.ts");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../environments/environment */ "../frontend/app-store-catalog/src/environments/environment.ts");
/* harmony import */ var _services_catalog_page_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/catalog-page.service */ "../frontend/app-store-catalog/src/page-catalog/services/catalog-page.service.ts");
...
function PageCatalogComponent_spy_chips_12_Template(rf, ctx) { if (rf & 1) {
...
class PageCatalogComponent {
    constructor(apiService, translateService, catalogPageService) {
        ...
        this.apps$ = this.apiService.appsGet(this.translateService.currentLang, _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].tenantId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => this.prepareCardData(res)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => this.isAppsLoading$.next(false)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: true }));
        this.applicationsCount$ = this.apps$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((apps) => apps.length));
        this.categoryOptions = [
            { title: 'All Categories', value: 0 },
            { title: 'BI Analytics', value: 1 },
            { title: 'Commerce', value: 2 },
            { title: 'Customer', value: 3 },
            { title: 'Data Integration', value: 4 },
            { title: 'Marketing', value: 5 },
            { title: 'Operational Cloud', value: 6 },
        ];
        this.selectedCategoryIndex = 0;
        this.navigationItems = this.categoryOptions.map((option) => ({
            title: option.title,
            url: '#',
            isActive: option.value === this.selectedCategoryIndex,
        }));
    ...
    prepareCardData(cardData) {
        return cardData.data.map((cardDataItem) => ({
            ...
            status: cardDataItem.attributes.status,
...
(function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PageCatalogComponent, [{
    ...
    }], function () { return [{ type: _swagger__WEBPACK_IMPORTED_MODULE_1__["DefaultService"] }, { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateService"] }, { type: _services_catalog_page_service__WEBPACK_IMPORTED_MODULE_6__["CatalogPageService"] }]; }, null); })();
...
PageCatalogModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function PageCatalogModule_Factory(t) { return new (t || PageCatalogModule)(); }, imports: [[
            ...
            _assets_icons__WEBPACK_IMPORTED_MODULE_14__["IconStarModule"],
        ]] });
...
class CatalogPageService {
    ...
    getTopFilterItems() {
        ...
        const filterTranslationConstants = ['NEW', 'POPULAR', 'GOLD_PARTNER', 'SILVER_PARTNER'].map((translationConstant) => `${filterTranslationsPrefix}.${translationConstant}`);
...
/*!***************************************************************!*\
  !*** ../frontend/app-store-catalog/src/page-catalog/types.ts ***!
  \***************************************************************/
/*! exports provided: PartnerType, randomPartnerType, getRandomRate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PartnerType", function() { return PartnerType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "randomPartnerType", function() { return randomPartnerType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomRate", function() { return getRandomRate; });
var PartnerType;
